<template>
  <div class="container">
    ...
    <div class="border p-2 text-align text-center bg-white">
      <p>
        By accepting these terms and conditions you give consent for Kangaroo Service Money
        ...
        reporting agency may prepare and provide Kangaroo Service Money Transfer with such
        ...
        Kangaroo Service Money Transfer so that we can discuss other options with you.
      </p>
    </div>
    ...
    <form class="p-2" @submit.prevent="dnbSubmit">
      <div class="form-check">
        ...
        <label class="form-check-label" for="exampleCheck1"
          >I agree to provide consent and accept the above terms and
          conditions.</label
        >
      </div>
...
export default {
  ...
  methods: {
    ...
    dnbSubmit(submitEvent) {
      console.log(submitEvent, "INI SUBMIT DNB");
      //  this.$router.push("/");
      let body = {
        tandc: this.tandc ? "on" : "",
      };
      console.log(body);
      this.$store.dispatch("postDnb", body);
    },
  },
};
</script>
